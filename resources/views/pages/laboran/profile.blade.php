...
@section('title')
<title>Data Laboran</title>
@endsection

@section('content')
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">Data Laboran</h1>
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="./">Home</a></li>
        <li class="breadcrumb-item active" aria-current="page">Data Laboran</li>
    </ol>
</div>

<div class="card">
    <div class="card-body">
        <form action="{{ route('ka_lab.profile-update') }}" method="POST">
            @csrf
            @method('PATCH')
